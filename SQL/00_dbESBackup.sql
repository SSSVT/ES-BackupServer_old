...
BEGIN /* IX */
	...
	CREATE INDEX IX_esbk_tbBackups_BK_TIME_BEGIN ON esbk_tbBackups(BK_TIME_BEGIN);
...
END
BEGIN /* DF */
	ALTER TABLE esbk_tbAdministrators ADD CONSTRAINT DF_esbk_tbAdministrators_AD_REGISTRATION_DATE DEFAULT (GETUTCDATE()) FOR AD_REGISTRATION_DATE;
	...
	ALTER TABLE esbk_tbClients ADD CONSTRAINT DF_esbk_tbClients_CL_META_REGISTRATION_DATE DEFAULT (GETUTCDATE()) FOR CL_META_REGISTRATION_DATE;
	...
	ALTER TABLE esbk_tbBackups ADD CONSTRAINT DF_esbk_tbBackups_BK_TIME_BEGIN DEFAULT (GETUTCDATE()) FOR BK_TIME_BEGIN;
...
END
BEGIN /* CK */
	ALTER TABLE esbk_tbAdministrators ADD CONSTRAINT CK_esbk_tbAdministrators_AD_REGISTRATION_DATE CHECK (AD_REGISTRATION_DATE <= GETUTCDATE());
	ALTER TABLE esbk_tbClients ADD CONSTRAINT CK_esbk_tbClients_CL_LAST_BACKUP CHECK (CL_LAST_BACKUP <= GETUTCDATE());
	ALTER TABLE esbk_tbClients ADD CONSTRAINT CK_esbk_tbClients_CL_LAST_STATUS_REPORT CHECK (CL_LAST_STATUS_REPORT <= GETUTCDATE());
	ALTER TABLE esbk_tbClients ADD CONSTRAINT CK_esbk_tbClients_CL_META_REGISTRATION_DATE CHECK (CL_META_REGISTRATION_DATE <= GETUTCDATE());
	...
	ALTER TABLE esbk_tbBackups ADD CONSTRAINT CK_esbk_tbBackups_BK_EXPIRATION CHECK (BK_EXPIRATION >= GETUTCDATE());
	ALTER TABLE esbk_tbBackups ADD CONSTRAINT CK_esbk_tbBackups_BK_TIME_BEGIN CHECK (BK_TIME_BEGIN <= GETUTCDATE());
	ALTER TABLE esbk_tbBackups ADD CONSTRAINT CK_esbk_tbBackups_BK_TIME_END CHECK (BK_TIME_BEGIN <= BK_TIME_END AND BK_TIME_END <= GETUTCDATE());
