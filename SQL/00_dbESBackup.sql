...
END
BEGIN /* DF */
	ALTER TABLE esbk_tbAdministrators ADD CONSTRAINT DF_esbk_tbAdministrators_AD_REGISTRATION_DATE_UTC DEFAULT (GETUTCDATE()) FOR AD_REGISTRATION_DATE_UTC;
...
END
BEGIN /* CK */
	ALTER TABLE esbk_tbAdministrators ADD CONSTRAINT CK_esbk_tbAdministrators_AD_REGISTRATION_DATE_UTC CHECK (AD_REGISTRATION_DATE_UTC <= GETUTCDATE());
	ALTER TABLE esbk_tbClients ADD CONSTRAINT CK_esbk_tbClients_CL_LAST_BACKUP_UTC CHECK (CL_LAST_BACKUP_UTC <= GETUTCDATE());
	ALTER TABLE esbk_tbClients ADD CONSTRAINT CK_esbk_tbClients_CL_LAST_STATUS_REPORT_UTC CHECK (CL_LAST_STATUS_REPORT_UTC <= GETUTCDATE());
